...
from src.l1_databases.sql.management.structured_memory import SQLStructuredMemory
...
class SQLManager:
    ...
    def __init__(
        ...
        self.structured_memory = SQLStructuredMemory(
            db=self.db, max_active=memory_max_active, context_limit=memory_context_limit
        )
    ...
    async def connect(self) -> None:
        ...
        await self.structured_memory.bootstrap_migrations()
