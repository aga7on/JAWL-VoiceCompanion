...
class SQLDB:
    ...
    def __init__(self, db_path: str) -> None:
        ...
        # JAWL can receive a foreground Companion event while a heartbeat
        # cycle is being cancelled.  SQLite must wait for the short-lived
        # rollback/commit boundary instead of surfacing a transient lock as a
        # fatal ReAct cycle.  WAL keeps read projections from blocking the
        # single writer; the native JAWL loop remains the sole owner.
