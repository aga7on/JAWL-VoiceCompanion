...
class EventBridge:
    ...
    def setup_routing(self) -> None:
        ...
        system_events = {
            ...
            # Operator delivery is passive infrastructure feedback generated by
            # the current action. Feeding it back into Heartbeat would create a
            # self-triggering ReAct event without adding decision evidence.
            Events.CODING_APPROVAL_REQUESTED.name,
        }
