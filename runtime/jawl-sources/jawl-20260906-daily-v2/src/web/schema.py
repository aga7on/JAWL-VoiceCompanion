...
INTERFACES_FIELDS: Dict[str, str] = {
    ...
    "interfaces:host.os.desktop_max_windows": "host.os.desktop_max_windows",
    "interfaces:host.os.desktop_max_elements": "host.os.desktop_max_elements",
    "interfaces:host.os.desktop_max_text_chars": "host.os.desktop_max_text_chars",
    "interfaces:host.os.desktop_max_result_chars": "host.os.desktop_max_result_chars",
    "interfaces:host.os.desktop_operation_timeout_sec": "host.os.desktop_operation_timeout_sec",
    ...
    "interfaces:host.os.coding_execution_backend": "host.os.coding_execution_backend",
    "interfaces:host.os.coding_approval_mode": "host.os.coding_approval_mode",
    "interfaces:host.os.coding_approval_ttl_sec": "host.os.coding_approval_ttl_sec",
    "interfaces:host.os.coding_container_runtime": "host.os.coding_container_runtime",
    "interfaces:host.os.coding_container_image": "host.os.coding_container_image",
    "interfaces:host.os.coding_container_network": "host.os.coding_container_network",
    "interfaces:host.os.coding_container_memory_mb": "host.os.coding_container_memory_mb",
    "interfaces:host.os.coding_container_cpus": "host.os.coding_container_cpus",
    "interfaces:host.os.coding_container_pids": "host.os.coding_container_pids",
    ...
    "interfaces:telegram.telethon.download_visual_media": "telegram.telethon.download_visual_media",
    "interfaces:telegram.telethon.visual_media_max_mb": "telegram.telethon.visual_media_max_mb",
    "interfaces:telegram.telethon.coding_approval_chat_id": "telegram.telethon.coding_approval_chat_id",
    "interfaces:telegram.telethon.coding_approval_remote_decisions": "telegram.telethon.coding_approval_remote_decisions",
    "interfaces:telegram.telethon.coding_approval_actor_id": "telegram.telethon.coding_approval_actor_id",
    ...
    "interfaces:telegram.aiogram.download_visual_media": "telegram.aiogram.download_visual_media",
    "interfaces:telegram.aiogram.visual_media_max_mb": "telegram.aiogram.visual_media_max_mb",
    "interfaces:telegram.aiogram.coding_approval_chat_id": "telegram.aiogram.coding_approval_chat_id",
    "interfaces:telegram.aiogram.coding_approval_remote_decisions": "telegram.aiogram.coding_approval_remote_decisions",
    "interfaces:telegram.aiogram.coding_approval_actor_id": "telegram.aiogram.coding_approval_actor_id",
    ...
    "interfaces:multimodality.video_understanding_enabled": "multimodality.video_understanding_enabled",
    "interfaces:multimodality.media_generation_enabled": "multimodality.media_generation_enabled",
    "interfaces:multimodality.media_request_timeout_sec": "multimodality.media_request_timeout_sec",
    "interfaces:multimodality.media_poll_interval_sec": "multimodality.media_poll_interval_sec",
    "interfaces:multimodality.media_max_upload_mb": "multimodality.media_max_upload_mb",
    "interfaces:multimodality.media_max_download_mb": "multimodality.media_max_download_mb",
    "interfaces:mcp.enabled": "mcp.enabled",
    "interfaces:mcp.startup_timeout_sec": "mcp.startup_timeout_sec",
    "interfaces:mcp.request_timeout_sec": "mcp.request_timeout_sec",
    "interfaces:mcp.max_catalog_items": "mcp.max_catalog_items",
    "interfaces:mcp.max_result_chars": "mcp.max_result_chars",
    "interfaces:mcp.max_binary_bytes": "mcp.max_binary_bytes",
    "interfaces:debug_broker.enabled": "debug_broker.enabled",
    "interfaces:debug_broker.re_root": "debug_broker.re_root",
    "interfaces:debug_broker.auto_start": "debug_broker.auto_start",
    "interfaces:debug_broker.startup_timeout_sec": "debug_broker.startup_timeout_sec",
    "interfaces:debug_broker.request_timeout_sec": "debug_broker.request_timeout_sec",
    "interfaces:debug_broker.max_result_chars": "debug_broker.max_result_chars",
    "interfaces:debug_broker.max_sessions": "debug_broker.max_sessions",
    "interfaces:debug_broker.x64dbg_port_start": "debug_broker.x64dbg_port_start",
    "interfaces:debug_broker.x64dbg_port_end": "debug_broker.x64dbg_port_end",
...
INTERFACES_LISTS: Dict[str, str] = {
    "lstCodingHostCommands": "host.os.coding_host_allowed_commands",
    "lstExcludeDirs":    "code_graph.exclude_dirs",
    "lstDebugProviders": "debug_broker.enabled_providers",
...
INTERFACES_OBJECT_LISTS: Dict[str, tuple] = {
    "lstCodingCommandProfiles": (
        "host.os.coding_command_profiles",
        ["name", "argv", "relative_cwd", "timeout_seconds", "container_profile"],
    ),
    "lstCodingContainerProfiles": (
        "host.os.coding_container_profiles",
        ["name", "image", "network", "memory_mb", "cpus", "pids"],
    ),
    "lstFeeds": ("web.rss.feeds", ["name", "url"]),
    "lstMcpServers": ("mcp.servers", ["name", "transport"]),
}
