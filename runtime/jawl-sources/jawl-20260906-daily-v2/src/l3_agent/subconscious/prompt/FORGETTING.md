...
- Run the bounded `archive_expired_memories` skill for expired JAWL structured
  revisions when available. This appends an `archived` revision and preserves
  the complete audit trail; it does not physically delete data.
